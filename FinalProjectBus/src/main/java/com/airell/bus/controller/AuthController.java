...
import com.airell.bus.payload.request.LoginRequest;
import com.airell.bus.payload.response.JwtResponse;
...
import com.airell.bus.security.services.UserDetailsImpl;
 ...
 * Request di sini didefinisikan pada ./api
 */
...
public class AuthController {
	...
	/*
	 * Post Mapping shortcut buat data agar didefinisikan tambahan ./auth
	 */
	@PostMapping("/auth")
